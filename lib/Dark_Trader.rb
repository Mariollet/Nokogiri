...
def crypto_name_scrapper #scrapper les noms de toutes les cryptos
...
def crypto_price_scrapper #scrapper les prix de toutes les cryptos
    page = Nokogiri::HTML(open("https://coinmarketcap.com/all/views/all/"))
    crypto_price = []
...
def crypto_all #associés leurs noms avc leurs valeurs
	crypto_all = []
